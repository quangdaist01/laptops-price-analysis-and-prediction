...
alternative_names = \
    {'Bảo hành cũ': 'used_warranty',
     ...
     'Hệ điều hành': 'os',
     'Thời điểm ra mắt': 'released_year'
     }

ordered_columns = \
    ['id', 'name', 'brand', 'cpu_type', 'cpu_speed', 'gpu_type', 'ram_type', 'ram', 'ram_speed', 'storage', 'screen_size', 'resolution', 'material', 'os', 'weight', 'thickness', 'width', 'length', 'released_year', 'new_warranty', 'used_warranty', 'new_price', 'used_price', 'is_sold']

ordered_columns.remove('is_sold')
